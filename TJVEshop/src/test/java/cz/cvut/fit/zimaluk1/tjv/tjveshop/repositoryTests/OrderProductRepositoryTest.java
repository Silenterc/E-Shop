...
public class OrderProductRepositoryTest {
    ...
    public void findAllByOrderIDTest(){
        ...
        Assertions.assertEquals(2, oprepo.findAllByOrderId(1L).size());
        Assertions.assertEquals(1, oprepo.findAllByOrderId(2L).size());
        Assertions.assertEquals(0, oprepo.findAllByOrderId(3L).size());
    }
}
